<div class="container is-fluid mb-6">
	...
	<h2 class="subtitle">Nuevo Propietario</h2>
</div>
...
<?php
	...
	<form action="./php/propietario_guardar.php" method="POST" class="FormularioAjax" autocomplete="off" >
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
				<h4><b><font color="blue"><label>Nombre del propietario</label></font></b></h4>
				  	<input class="input" type="text" name="pro_nombre" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,40}" maxlength="40" required >
				</div>
		  	</div>
			<div class="column">
