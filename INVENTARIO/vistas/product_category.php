...
<div class="container pb-4 pt-4">
    ...
    <div class="columns">
        <div class="column is-one-fifth">
            ...
            <h2 class="title has-text-justified">Categorías</h2>
            <?php
                $categorias=conexion();
                ...
                if($categorias->rowCount()>0){
                    ...
                    echo '<p class="has-text-justified" >No hay categorías registradas</p>';
                }
                $categorias=null;
            ?>
        </div>
        ...
        ?>
            <?php
                ...
                if($check_categoria->rowCount()>0){
                    ...
                    echo '
                        <h2 class="title has-text-justified">'.$check_categoria['categoria_nombre'].'</h2>
                        <p class="has-text-justified pb-6" >'.$check_categoria['categoria_ubicacion'].'</p>
                    ';
                    ...
                    # Paginador producto #
                    require_once "./php/producto_lista_prueba.php";

                }else{
                    echo '<h2 class="has-text-justified title" >Seleccione una categoría para empezar</h2>';
                }
