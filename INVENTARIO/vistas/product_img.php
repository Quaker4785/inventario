...
<div class="container pb-6 pt-6">
	...
	<div class="columns">
		<div class="column is-two-fifths">
			...
			<figure class=" img-fluid image mb-6">
			  	<img src="./img/producto/<?php echo $datos['producto_foto']; ?>" class="" alt="Responsive image">
			</figure>
		...
		<div class="column">
			<form class="mb-6 has-text-centered FormularioAjax" action="./php/producto_img_actualizar.php" method="POST" enctype="multipart/form-data" autocomplete="off" >
				...
				<h4 class="title is-4 mb-6"><font color="red"><?php echo $datos['producto_nombre']; ?></font></h4>
				<h4 class="title is-4 mb-6"><font color="blue"><?php echo $datos['producto_stock']." -- ".$datos['producto_unidad']; ?></font></h4>
