<?php
    ...
    $propietario=limpiar_cadena($_POST['nombre_propie']);
	$categoria=limpiar_cadena($_POST['producto_categoria']);
    
	/*== Verificando campos obligatorios ==*/
    if($codigo=="" || $nombre=="" || $unidad=="" || $stock=="" || $categoria=="" || $ubicacion=="" || $referencia=="" || $contenedor==""){
        echo '
    ...
    $guardar_producto=$guardar_producto->prepare("INSERT INTO producto(producto_codigo, producto_nombre, producto_unidad, 
    producto_stock, producto_ubicacion, producto_referencia, producto_contenedor, producto_fecha, producto_foto, categoria_id, 
    usuario_id, propietario_id)
    VALUES(:codigo,:nombre,:unidad,:stock,:ubicacion,:referencia,:contenedor,:fecha,:foto,:categoria,:usuario,:propie)");
