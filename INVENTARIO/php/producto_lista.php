				...
				<article class="media">
			        <figure class="media-left">
			            ...
			            if(is_file("./img/producto/".$rows['producto_foto'])){
			            	$tabla.='<img src="./img/producto/ '.$rows['producto_foto'].'" clas="rounded mx-auto d-block">';
			            }else{
			        ...
			        <div class="media-content">
			            <div class="content">
			              <p>
			                ...
			                <strong>CODIGO:</strong> '.$rows['producto_codigo'].', <strong>UNIDAD:</strong> '.$rows['producto_unidad'].',
						    <strong>STOCK:</strong> '.$rows['producto_stock'].', <strong>UBICACION:</strong> '.$rows['producto_ubicacion'].', 
							<strong>REFERENCIA:</strong> '.$rows['producto_referencia'].',<strong>CONTENEDOR:</strong> '.$rows['producto_contenedor'].',
							<strong>FECHA:</strong> '.$rows['producto_fecha'].',<strong>CATEGORIA:</strong> '.$rows['categoria_nombre'].',
